...
_e(function (E, $) {
    E.createMenu(function (check) {
        ...
        menu.updateSelectedEvent = function () {
            var rangeElem = editor.getRangeElem();
            rangeElem = editor.getSelfOrParentByName(rangeElem, 'p,h1,h2,h3,h4,h5');
            if (rangeElem) {
                return true;
            }
            return false;
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        // 菜单正常状态下，点击将触发该事件
        menu.clickEvent = function (e) {
            editor.command(e, 'insertHorizontalRule');           
        };
